public class FRIExpress extends Ekspedisi 
{
    ...
    public void informasi(){
        if (pecahBelah == true){
            System.out.println("Ekspedisi FRIExpress dengan jumlah cabang " + jumlahCabang + " dan berpusat di " + pusat + " mempunyai tarif sebesar " + tarif + " perkilogram. Selain itu, ekspedisi ini melayani paket pecah belah" );
        } else {
    ...
    public void kirim(String tujuan){
        System.out.println("FRIExpressbaru saja mengirimkan paket ke tujuan " + tujuan);
    }

    // TO DO: Create 'kirim' Method to send a package to two destinations
    public void kirim(String tujuan_1, String tujuan_2){
        System.out.println("FRIExpress mengirimkan paket ke tujuan " + tujuan_1 + " dan " + tujuan_2);
    }
